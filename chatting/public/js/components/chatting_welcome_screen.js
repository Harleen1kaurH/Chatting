import chattingForm from './chatting_form';

export default class chattingWelcome {
  constructor(opts) {
  ...
  setup() {
    this.$chatting_welcome_screen = $(document.createElement('div')).addClass(
      'chatting-welcome'
    );
    ...
    const status_text =
      this.profile.chatting_status === 'Online'
        ? __('We are online')
        : __('We are offline');
